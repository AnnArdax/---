...
file_size = speed_in_kb_in_sec * time_in_sec # TODO размер файла в Кб
paid_traffic = max(0, file_size - free_traffic)
total_coast = cost * paid_traffic # TODO стоимость файла
